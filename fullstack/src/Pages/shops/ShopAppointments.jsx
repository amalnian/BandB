...
import ServicesContent from '../shops/components/AppointmentsContent';
import AppointmentsContent from '../shops/components/AppointmentsContent';
...
const ShopAppointments = () => {
  ...
  return <AppointmentsContent shopId={shopData?.id} />;
};
